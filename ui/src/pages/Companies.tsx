...
export function Companies() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">Caricamento aziende...</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {agentCount} {agentCount === 1 ? "agente" : "agenti"}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {issueCount} {issueCount === 1 ? "attivita'" : "attivita'"}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">Budget illimitato</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>Creata {relativeTime(company.createdAt)}</span>
                </div>
              </div>
              ...
              {isConfirmingDelete && (
                ...
                >
                  <p className="text-sm text-destructive font-medium">
                    Eliminare questa azienda e tutti i suoi dati? L'azione non puo' essere annullata.
                  </p>
