...
import { BlueprintRunDetail } from "./pages/BlueprintRunDetail";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="blueprint-runs/:runId" element={<BlueprintRunDetail />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="blueprints" element={<UnprefixedBoardRedirect />} />
          <Route path="blueprint-runs/:runId" element={<UnprefixedBoardRedirect />} />
